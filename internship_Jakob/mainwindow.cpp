    ...
    , ui(new Ui::MainWindow)
{
    ...
    //Item for choose percentage
    ui->comboBox_percentage->addItem("");
    ui->comboBox_percentage->addItem("95");
    ui->comboBox_percentage->addItem("90");
    ui->comboBox_percentage->addItem("85");
    ui->comboBox_percentage->addItem("80");
    ui->comboBox_percentage->addItem("75");
    ui->comboBox_percentage->addItem("70");
    ui->comboBox_percentage->addItem("65");
    ui->comboBox_percentage->addItem("60");
    ui->comboBox_percentage->addItem("55");
    ui->comboBox_percentage->addItem("50");
...
void MainWindow::find_segmentation(QVector<QVector<double>> *tb, QVector<QVector<double>> *segm)
{
    ...
    percentage = ui->comboBox_percentage->currentText().toDouble();
